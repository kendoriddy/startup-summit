const projectData = [
  {
    snapshot: './assets/images/kenny.jpg',
    speakerName: 'Kehinde Ridwan Onifade',
    speakerTitle: 'Co-Founder and CEO, Nifadera Inc. and a board member of IFA Nigeria',
    description:
        'Kehinde is a software developer turned entrepreneur. His ambition and passion for solving problems led him to the path of technology.',
  },
  {
    snapshot: './assets/images/patricia.jpeg',
    speakerName: 'Hanu Fejiro Agbodje',
    speakerTitle: 'Founder and CEO, Patricia Inc. and a board member of IFA Nigeria',
    description:
        'He is an entrepreneur and is well known as the CEO of the company Patricia. He is an Urhobo man from the Udo Local Government in Delta state.',
  },
  {
  ...
  {
    snapshot: './assets/images/oyin.jpeg',
    speakerName: 'Oyinlade Ojesanmi',
    speakerTitle: 'Founder and CEO, Lade Tech, and a board member of IFA Nigeria',
    description:
        "Oyinlade is a rising star in Nigeria tech space. She's being taunted as the next big thing in the industry. Within two years, her company already have branches in seven African countries",
  },
];
